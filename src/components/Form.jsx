...
const Form = ({setNewCardID, newCardID}) => {
    ...
    return <form className="m-5 lg:flex lg:flex-row lg:flex-wrap lg:justify-between lg:p-5" onSubmit={(e) => submitFunc(e)}>
        <div className="sm:w-10/12 sm:m-auto md:w-8/12 md:flex md:flex-row md:justify-between md:gap-10 md:my-2 lg:w-full">
            <div className="md:w-6/12 lg:justify-self-start">
            ...
            <div className="md:w-6/12 lg:justify-self-end">
        ...
        <div className="sm:w-10/12 sm:m-auto md:w-8/12 md:w-full md:my-2">
        ...
        <div className="sm:w-10/12 sm:m-auto md:w-8/12 md:w-full md:my-2">
            ...
            <input className={basicValidation(logo, "block bg-stone-100 rounded-3xl text-sm text-left placeholder-stone-400 py-3 pl-4 w-11/12 md:w-8/12 md:m-auto lg:w-full")} type="text"  id="logo-input" name="logo-input" placeholder="Paste your logo image URL here" onChange={(e) => setLogo(websiteValidation(e.target.value))} ></input>
            {checkIcon(logo)}
        </div>
        <div className="m-auto my-2 sm:w-10/12 md:w-8/12 sm:flex sm:flex-row sm:justify-between sm:gap-1 md:gap-10 lg:w-full">
            <div className="w-full">
                <label className="block text-sm leading-8" htmlFor="color-input-front-bg">Front Background Colour</label>
                <div className="block h-10 bg-stone-100 rounded-3xl w-11/12 sm:w-10/12 md:w-full">
            ...
            <div className="w-full">
                ...
                <div className="block bg-stone-100 h-10 rounded-3xl w-11/12 sm:w-10/12 md:w-full">
        ...
        <div className="m-auto flex sm:w-10/12 md:w-full md:my-2">
